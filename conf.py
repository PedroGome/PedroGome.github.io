...
BLOG_AUTHOR = "Pedro"  # (translatable)
BLOG_TITLE = "Grupo G"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://PedroGome.github.io/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://PedroGome.github.io/"
BLOG_EMAIL = "pedro.gomezm@edu.uah.es"
BLOG_DESCRIPTION = "Libre difusion de Conocimiento"  # (translatable)
...
# Index path to not conflict with blog
INDEX_PATH = 'blog'
